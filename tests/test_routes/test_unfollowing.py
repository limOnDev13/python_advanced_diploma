...
async def test_unfollow_author(
    ...
    response = await client.delete(
        BASE_ROUTE.format(user_id=author_id, api_key=follower_api_key)
    )
    ...
    response = await client.delete(
        BASE_ROUTE.format(user_id=follower_id, api_key=follower_api_key)
    )
...
async def test_unfollow_with_invalid_api_key(
    ...
    response = await client.delete(
        BASE_ROUTE.format(user_id=author_id, api_key=invalid_api_key)
    )
...
async def test_unfollow_not_existing_user(
    ...
    response = await client.delete(
        BASE_ROUTE.format(user_id=invalid_author_id, api_key=follower_api_key)
    )
